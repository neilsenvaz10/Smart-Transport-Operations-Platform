...
const roiChartData = [
  { vehicle: 'V-002', roi: 34 },
  { vehicle: 'V-005', roi: 28 },
  { vehicle: 'V-008', roi: 31 },
  { vehicle: 'V-001', roi: 22 },
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field label="License Plate">
              <input className={ic} placeholder="ABC-1234" />
            </Field>
            <Field label="Year">
              <input type="number" className={ic} placeholder="2024" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field label="Current Mileage">
              <input className={ic} placeholder="0 mi" />
            </Field>
          </div>
          <div className="flex gap-3 pt-2">
            ...
            <button className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-[13px] font-semibold transition-colors">
              Add Vehicle
            </button>
          </div>
        </div>
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-blue-100 shadow-sm p-6">
          ...
          <div className="flex justify-end gap-3 mt-4">
            ...
            <button className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-[13px] font-semibold transition-colors">
              Save Record
            </button>
          </div>
        </div>
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-50">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-[12px] font-semibold rounded-lg transition-colors"
          >
            <Plus size={12} />
            Add Fuel Entry
          </button>
      ...
      <Modal open={showFuel} onClose={() => setShowFuel(false)} title="Add Fuel Entry">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field label="Liters">
              <input type="number" className={ic} placeholder="0" />
            </Field>
            <Field label="Cost per Liter ($)">
              <input type="number" className={ic} placeholder="0.00" step="0.01" />
            </Field>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <Field label="Date">
            ...
            <Field label="Odometer Reading">
              <input type="number" className={ic} placeholder="0 mi" />
            </Field>
          </div>
          <Field label="Fuel Station">
            <input className={ic} placeholder="e.g. Shell — Chicago, IL" />
          </Field>
          <div className="flex gap-3 pt-2">
            <button
              onClick={() => setShowFuel(false)}
              className="flex-1 py-2.5 border border-slate-200 text-slate-700 rounded-xl text-[13px] font-medium hover:bg-slate-50"
            >
              Cancel
            </button>
            <button className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-[13px] font-semibold">
              Save Entry
            </button>
          </div>
        </div>
      ...
      <Modal open={showExp} onClose={() => setShowExp(false)} title="Add Expense">
        <div className="space-y-4">
          ...
          <Field label="Description">
            <input className={ic} placeholder="Brief description of expense" />
          </Field>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field label="First Name">
            <input
              className={ic}
              value={profile.first}
              onChange={(e) => setP('first', e.target.value)}
            />
          </Field>
          <Field label="Last Name">
            <input
              className={ic}
              value={profile.last}
              onChange={(e) => setP('last', e.target.value)}
            />
          </Field>
          <Field label="Email Address">
            <input
          ...
          <Field label="System Role">
            <div
              className={cn(
                ic,
                'flex items-center gap-2 bg-slate-50 cursor-not-allowed select-none',
              )}
            >
                  ...
                  <TD>
                    <div className="flex items-center gap-3">
                      ...
                      {r.name !== 'Administrator' && (
                        <button className="text-[12px] text-red-500 hover:text-red-600 font-medium transition-colors">
                          Delete
                        </button>
                      )}
                    </div>
